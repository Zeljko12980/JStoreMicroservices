...
{
    public class GetAllUsersDetailsQuery : IQuery<List<UserDetailsResponseDto>>
    {
    }

    public class GetAllUsersDetailsQueryHandler : IQueryHandler<GetAllUsersDetailsQuery, List<UserDetailsResponseDto>>
    {
